...
def encode_clip(
    ...
    Args:
        ...
        default_layer: Default hidden layer to use
        layer_skip: Number of layers to skip
        text_encoder_output: Optional cached encoder output
        add_pooled_output: Whether to return pooled output
        pooled_text_encoder_output: Optional cached pooled output
        use_attention_mask: Whether to use attention mask
        add_layer_norm: Whether to add layer normalization
        
    Returns:
        Tuple of (encoder output, optional pooled output)
    """
